// Orb JS WebGL Animation
        (function() {
            ...
            const params = {
                ...
                backgroundColor: hexToVec3("#000000")
            };
            ...
            const render = (time) => {
                ...
                const targetHover = (isHovered || params.forceHoverState) ? 1 : 0;
                currentHover += (targetHover - currentHover) * 0.1;

                if (params.rotateOnHover && currentHover > 0.5) {
                    currentRot += dt * 0.3;
                }
                ...
                gl.uniform1f(uniforms.hoverIntensity, params.hoverIntensity);
                gl.uniform3f(uniforms.backgroundColor, params.backgroundColor[0], params.backgroundColor[1], params.backgroundColor[2]);
